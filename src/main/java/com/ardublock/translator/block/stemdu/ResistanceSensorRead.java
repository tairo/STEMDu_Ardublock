...
public class ResistanceSensorRead extends TranslatorBlock {

	public ResistanceSensorRead(Long blockId, Translator translator) {
	...
	public String toCode() throws SocketNullException,
		...
		String ret = "_STEMDU_robot.readResistanceC()";
