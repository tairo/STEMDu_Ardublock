...
public class S11059Blue extends TranslatorBlock {

	public S11059Blue(Long blockId, Translator translator) {
		super(blockId, translator);
		// TODO Auto-generated constructor stub
	}

	public S11059Blue(Long blockId, Translator translator, String codePrefix, String codeSuffix) {
		super(blockId, translator, codePrefix, codeSuffix);
		// TODO Auto-generated constructor stub
	}

	public S11059Blue(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
		super(blockId, translator, codePrefix, codeSuffix, label);
		// TODO Auto-generated constructor stub
	}

	private final static String _STEMDU_readBlueFunction = "int _STEMDU_readBlueFunction() {_STEMDU_colorSensor.delay(); if (_STEMDU_colorSensor.update()) { return _STEMDU_colorSensor.getBlue(); }else{ return 0; }}";
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException, BlockException {
		...
		translator.addDefinitionCommand(_STEMDU_readBlueFunction);
		...
		return codePrefix + "_STEMDU_readBlueFunction();" + codeSuffix;
	}
