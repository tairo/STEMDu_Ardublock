...
public class MotorForwardM3M4 extends TranslatorBlock {

	public MotorForwardM3M4(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
		...
		String ret = "\t_STEMDU_robot.forwardM3M4(" + speed + ");\n";
		return ret;
	}
