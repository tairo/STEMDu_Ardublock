...
public class MotorTank extends TranslatorBlock {

	public MotorTank(Long blockId, Translator translator) {
		super(blockId, translator);
		// TODO Auto-generated constructor stub
	}

	public MotorTank(Long blockId, Translator translator, String codePrefix,
			String codeSuffix) {
	...
	public String toCode() throws SocketNullException,
		...
		String ret = "\t_STEMDU_robot.tankM1M2(" + speed1 + "," + speed2 + ");\n";
		return ret;
	}
