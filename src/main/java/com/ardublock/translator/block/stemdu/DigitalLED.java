...
public class DigitalLED extends TranslatorBlock {

	public DigitalLED(Long blockId, Translator translator) {
		super(blockId, translator);
		// TODO Auto-generated constructor stub
	}

	public DigitalLED(Long blockId, Translator translator, String codePrefix,
			String codeSuffix) {
	...
	public String toCode() throws SocketNullException,
		...
		String ret = "\t_STEMDU_robot.led((bool)" + bright + ");\n";
		return ret;
	}
