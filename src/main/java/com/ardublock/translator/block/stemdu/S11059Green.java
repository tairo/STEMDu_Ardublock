...
public class S11059Green extends TranslatorBlock {

	public S11059Green(Long blockId, Translator translator) {
		super(blockId, translator);
		// TODO Auto-generated constructor stub
	}

	public S11059Green(Long blockId, Translator translator, String codePrefix, String codeSuffix) {
		super(blockId, translator, codePrefix, codeSuffix);
		// TODO Auto-generated constructor stub
	}

	public S11059Green(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
		super(blockId, translator, codePrefix, codeSuffix, label);
		// TODO Auto-generated constructor stub
	}

	private final static String _STEMDU_readGreenFunction = "int _STEMDU_readGreenFunction() {_STEMDU_colorSensor.delay(); if (_STEMDU_colorSensor.update()) { return _STEMDU_colorSensor.getGreen(); }else{ return 0; }}";
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException, BlockException {
		...
		translator.addDefinitionCommand(_STEMDU_readGreenFunction);
		...
		return codePrefix + "_STEMDU_readGreenFunction();" + codeSuffix;
	}
