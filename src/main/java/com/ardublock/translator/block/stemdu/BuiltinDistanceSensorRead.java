...
public class BuiltinDistanceSensorRead extends TranslatorBlock {

	public BuiltinDistanceSensorRead(Long blockId, Translator translator) {
	...
	public String toCode() throws SocketNullException,
		...
		translator.addSetupCommand("_STEMDU_robot.initBuiltinDistance();\n");
		String ret = "_STEMDU_robot.readBuiltinDistance()";
