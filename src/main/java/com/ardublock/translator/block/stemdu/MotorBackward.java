...
public class MotorBackward extends TranslatorBlock {

	public MotorBackward(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
