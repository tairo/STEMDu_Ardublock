...
public class MotorTurnRightM3M4 extends TranslatorBlock {

	public MotorTurnRightM3M4(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
	...
	public String toCode() throws SocketNullException,
		...
		String ret = "\t_STEMDU_robot.rightM3M4(" + speed + ");\n";
		return ret;
	}
