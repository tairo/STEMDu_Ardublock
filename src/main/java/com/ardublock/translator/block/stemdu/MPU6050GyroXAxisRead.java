...
public class MPU6050GyroXAxisRead extends TranslatorBlock{
	public MPU6050GyroXAxisRead(Long blockId, Translator translator) {
	...
	private final static String mpu6050Function = "int16_t ardublockMPU6050GyroXAxisReturnCM(){\n  _STEMDU_accelgyro.getRotation(&_STEMDU_gx, &_STEMDU_gy, &_STEMDU_gz);\n  return _STEMDU_gx / 131.0;\n}\n";
	@Override
	public String toCode() throws SocketNullException,
		...
		return codePrefix + "ardublockMPU6050GyroXAxisReturnCM()" + codeSuffix;
	}
