...
public class MotorStop extends TranslatorBlock {

	public MotorStop(Long blockId, Translator translator) {
		super(blockId, translator);
		// TODO Auto-generated constructor stub
	}

	public MotorStop(Long blockId, Translator translator, String codePrefix,
			String codeSuffix) {
	...
	public String toCode() throws SocketNullException,
		...
		String ret = "\t_STEMDU_robot.stopM1M2();\n";
		return ret;
	}
