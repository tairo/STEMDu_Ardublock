...
public class BME680Gas extends TranslatorBlock {

	public BME680Gas(Long blockId, Translator translator) {
		super(blockId, translator);
		// TODO Auto-generated constructor stub
	}

	public BME680Gas(Long blockId, Translator translator, String codePrefix, String codeSuffix) {
		super(blockId, translator, codePrefix, codeSuffix);
		// TODO Auto-generated constructor stub
	}

	public BME680Gas(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
